...
app.get("/buildings-page", async (req, res) => {
  ...
  res.render("buildings-page", {
    currentPage: "buildings-page",
    buildings: buildings,
  })
})
